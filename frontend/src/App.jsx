...
function App() {
  ...
  return (
    <div>
      ...
      <div>
        <button onClick={() => setQuestions(questions1)}>1</button>
        <button onClick={() => setQuestions(questions2)}>2</button>
      </div>
      <div>
        {
          questions.map(question => <ProbemStatement
...
function ProbemStatement({ title, difficulty, acceptance }) {
  return (
    <tr>
      <td>{title}</td>
      <td>{difficulty}</td>
